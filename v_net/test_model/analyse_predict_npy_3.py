...
from v_net.test_model.vnet3_test import dir_num, model_num, model
# dir_num = 130
# model = "liver"
...
# 标签
label_path = "../dataset/vnet_3_3_test_npy/label/" + str(dir_num) + "/" + str(dir_num) + ".npy"
# label_path = "../dataset/vnet_3_3_test_npy/raw_label/" + str(dir_num) + "/" + str(dir_num) + ".npy"
train_path = "../dataset/vnet_3_3_test_npy/train/" + str(dir_num) + "/" + str(dir_num) + ".npy"

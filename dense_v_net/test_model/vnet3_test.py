...
dir_num = 129
model_num = "7"
model = "dense_vet_tumour"

test_npy = "../../v_net/dataset/vnet_3_3_test_npy/train/" + str(dir_num) + "/" + str(dir_num) + ".npy"
model_name = "./model_pre_mean/" + model + model_num + ".hdf5"
if not os.path.isdir("./predict_npy_pre_mean"):
    os.makedirs("./predict_npy_pre_mean")

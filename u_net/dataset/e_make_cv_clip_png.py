...
raw_slice_train_path = "./data_slice_tumour_modify_brightness/train"
raw_slice_label_path = "./data_slice_tumour_modify_brightness/label"


train_clip_save_path = "./data_cv_clip/train"
label_clip_save_path = "./data_cv_clip/label"

...
class myVnet(object):
    ...
    def encode_layer(self, kernel_num, kernel_size, input):
        conv = Conv3D(kernel_num, [1, 1, 1], activation='relu', padding='same',
        ...
        conv3 = Conv3D(kernel_num, kernel_size, activation='relu', padding='same',
                       kernel_initializer='he_normal')(conv2)
        conv3 = self.BN_operation(conv3)
        conv3 = Dropout(self.drop)(conv3)

        conv4 = Conv3D(kernel_num, [3, 1, 1], activation='relu', padding='same',

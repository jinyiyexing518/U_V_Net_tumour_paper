...
model_name = "./model_pre_mean_33/vnet_" + model + "_3_1_epoch" + model_num + ".hdf5"
predict_directory = "./predict_npy_pre_mean_33"
if not os.path.isdir(predict_directory):
    os.makedirs(predict_directory)
predict_result = "./predict_npy_pre_mean_33/predict" + str(dir_num) + "_" + model \
